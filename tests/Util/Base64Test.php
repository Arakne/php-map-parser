...
class Base64Test extends TestCase
{
    ...
    #[Test]
    public function ordInvalidChar()
    {
    ...
    #[Test]
    public function encodeSingleChar()
    {
        $charset = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_';
    ...
    #[Test]
    public function encodeWithTwoChars()
    {
        $this->assertEquals('cr', Base64::encode(145, 2));
    }

    #[Test]
    public function encodeWithTooSmallNumberWillKeepLength()
    {
    ...
    #[Test]
    public function decodeWithOneChar()
    {
    ...
    #[Test]
    public function decodeEncodeTwoChars()
    {
